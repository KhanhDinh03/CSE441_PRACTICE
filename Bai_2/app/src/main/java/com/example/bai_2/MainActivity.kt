...
class MainActivity : AppCompatActivity() {
    ...
    private var soA by Delegates.notNull<Int>()
    private var soB by Delegates.notNull<Int>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnKetQua = findViewById<Button>(R.id.btn_ket_qua)

        // Hiển thị kết quả sang txt_ket_qua trong ResultActivity
        btnKetQua.setOnClickListener(View.OnClickListener {
